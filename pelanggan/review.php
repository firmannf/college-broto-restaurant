...
<body>
  ...
  <section id="body" class="container">
   ...
   <div class="panel-body">
    <h3 align="center"> Untuk Meningkatkan pelayanan dan kualitas restoran, kami mohon  memberi review berupa komentar kritik  dan saran dengan  Sejujur Mungkin
    </h3>
   </div>
 </div>
 ...
 <div class="row">
   <div class="col-md-12 col-xs-12 col-lg-12 center-block">
    <button id="singlebutton" name="singlebutton" class="btn btn-success center-block" style="margin-top: 80px;">
        KIRIM REVIEW
    </button>
</div>
 </div>
