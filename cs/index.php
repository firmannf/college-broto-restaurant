...
<body class="sidebar-mini fixed">
      ...
      <div class="page-title">
        ...
        <div>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#" target="_blank" id="cetakminuman" onClick="print(4)">Minuman</a></li>
          </ul>
        </div>
      </div>
      <div class="row">
  ...
  <script type="text/javascript">
    ...
    function print(id) {
      if(id == 1) {
        document.getElementById("cetakpelayanan").href = document.getElementById("pelayanan").toDataURL();
      }else if(id == 2) {
        document.getElementById("cetakharga").href = document.getElementById("harga").toDataURL();
      }else if(id == 3) {
        document.getElementById("cetakmakanan").href = document.getElementById("makanan").toDataURL();
      }else if(id == 4) {
        document.getElementById("cetakminuman").href = document.getElementById("minuman").toDataURL();
      }
    }
  </script>
</body>
