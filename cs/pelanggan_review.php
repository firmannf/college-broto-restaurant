      ...
      <div class="page-title">
        ...
        <div>
          <?php
            if(isset($_GET['q'])) {
          ?>
          <a href="pelanggan_review.php" class="btn btn-success"><i class="fa fa-arrow-left"></i></a>
          <?php
            }
          ?>
          <a href="#" onClick="searchKeywords()" class="btn btn-default btn-flat"><i class="fa fa-search"></i></a>
          <a href="proses/review_cetak_proses.php" target="_blank" class="btn btn-default btn-flat"><i class="fa fa-print"></i></a>
        </div>
      </div>
      <div class="row">
        <?php
          if(isset($_GET['q'])){
            $strQuery = "SELECT p.id_pesanan, p.nama_pelanggan, p.tgl_order, k.pelayanan, k.harga, k.makanan, k.minuman, k.review
                            ...
                            ON p.id_pesanan = k.id_pesanan WHERE p.id_pesanan = '$_GET[q]' OR p.nama_pelanggan LIKE '%$_GET[q]%'
          ...
          <div class="card">
            ...
            <div class="row" style="border: 1px solid #AAA; padding: 8px 0px; margin: 8px 0px 0px;">
              <div class="col-md-12">
                <p><b>Review</b></p>
                <p>
                  <?php $review = $result['review'] == NULL ? "-" : $result['review']; echo $review;?>
                </p>
              </div>
            </div>
          </div>
      ...
      function searchKeywords() {
        swal({
          ...
          function (inputValue) {
            ...
            document.location.href = 'pelanggan_review.php?q=' + inputValue;
          });
      }
    </script>
  </div>
