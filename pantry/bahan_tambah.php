        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <form action="proses/bahan_tambah_proses.php" method="POST">
                  <div class="form-group">
                    <label class="control-label">Nama Bahan Baku</label>
                    <input type="text" name="nama_bahanbaku" placeholder="Masukkan nama bahan baku" class="form-control" required>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
